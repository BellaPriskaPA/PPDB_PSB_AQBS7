                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                        // Map status to human labels and badge styles
                                        if ($daftar['status'] == 2) {
                                            echo '<span class="badge badge-success">Diterima</span>';
                                        } elseif ($daftar['status'] == 1) {
                                            echo '<span class="badge badge-warning">Buka Pembayaran Awal</span>';
                                        } elseif ($daftar['status'] == 3) {
                                            echo '<span class="badge badge-info">Buka Daftar Ulang</span>';
                                        } else {
                                            echo '<span class="badge badge-secondary">Diverifikasi</span>';
                                        }
                                        ?>
                                    </td>
                                    <td>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="custom-switches-stacked mt-2">
                                                                    ...
                                                                    <label class="custom-switch">
                                                                        ...
                                                                        <span class="custom-switch-indicator"></span>
                                                                        <span class="custom-switch-description">Buka Pembayaran Awal</span>
                                                                    </label>
                                                                    <label class="custom-switch">
                                                                    ...
                                                                    <label class="custom-switch">
                                                                        <input type="radio" name="status" value="3" class="custom-switch-input" <?= ($daftar['status'] == 3 ? 'checked' : '') ?>>
                                                                        <span class="custom-switch-indicator"></span>
                                                                        <span class="custom-switch-description">Buka Daftar Ulang</span>
                                                                    </label>
