...
<?php
// Guard: pastikan parameter id tersedia sebelum mencoba mengaksesnya
if (!isset($_GET['id']) || trim($_GET['id']) === '') {
    echo '<div class="alert alert-warning">ID pendaftar tidak ditemukan. Kembali ke halaman daftar.</div>';
    exit;
}

// Ambil data siswa dengan aman; hentikan jika tidak ditemukan
$id_dekrip = dekripsi($_GET['id']);
$siswa = fetch($koneksi, 'daftar', ['id_daftar' => $id_dekrip]);
if (!$siswa) {
    echo '<div class="alert alert-danger">Data pendaftar tidak ditemukan atau sudah dihapus.</div>';
    exit;
}
?>
