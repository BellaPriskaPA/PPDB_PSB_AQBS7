...
<section class="section">
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
              ...
              <div class="breadcrumb-item">PSB Online</div>
            </div>
          </div>
          ...
          <td><div class="section-body">
			...
			<h2 class="section-title">Pengaturan Aplikasi PSB Online</h2>
            <p class="section-lead">
              Silahkan Sesuaikan Pengaturan PSB Online Disini
            </p>
    ...
    <ul class="nav nav-tabs" id="myTab5" role="tablist">
	  ...
	  <li class="nav-item">
        <a class="nav-link" id="kepala-tab5" data-toggle="tab" href="#kepala5" role="tab" aria-controls="kepala" aria-selected="false">
          <i class="fas fa-card"></i> Waktu PSB</a>
      </li>
    </ul>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4>INFO WAKTU PSB</h4>
            </div>
            <form id="syarat">
                <div class="card-body">
                    <div class="form-group">
                        <label>Kapan PSB Mulai Dibuka??</label>
