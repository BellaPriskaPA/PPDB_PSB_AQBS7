...
class PHPExcel_Shared_OLE
{
    ...
    */
     ...
     * @var PHPExcel_Shared_OLE_PPS_Root|null
    */
    public $root;
    ...
    */
    ...
    /**
     * Threshold (in bytes) below which streams are stored using small blocks
     * @var int
     */
    public $bigBlockThreshold = 0;
    ...
    * @param   int|PHPExcel_Shared_OLE_PPS   block id or PPS
    ...
    */
    ...
    {
        if (strlen($string) != 8) {
            // Invalid input; return 0 timestamp instead of PEAR_Error to avoid dependency on PEAR
            return 0;
        }
