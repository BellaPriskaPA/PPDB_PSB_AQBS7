            ...
            foreach ($xml->DocumentProperties[0] as $propertyName => $propertyValue) {
                switch ($propertyName) {
                    ...
                    case 'Author':
                        ...
                        break;
                    case 'Created':
                            $creationTimestamp = strtotime($propertyValue);
                            if ($creationTimestamp !== false) {
                                $dt = new DateTime();
                                $dt->setTimestamp($creationTimestamp);
                                $docProps->setCreated($dt);
                            } else {
                                $docProps->setCreated(null);
                            }
                            break;
                    case 'LastAuthor':
                        ...
                        break;
                    case 'LastSaved':
                            $lastSaveTimestamp = strtotime($propertyValue);
                            if ($lastSaveTimestamp !== false) {
                                $dt2 = new DateTime();
                                $dt2->setTimestamp($lastSaveTimestamp);
                                $docProps->setModified($dt2);
                            } else {
                                $docProps->setModified(null);
                            }
                            break;
                    case 'Company':
                                    ...
                                    foreach ($temp as &$value) {
                                        ...
                                        if ($key = !$key) {
                                            ...
                                            foreach ($cellReferences as $cellReference) {
                                                ...
                                                if (isset($rowReference[0]) && $rowReference[0] == '[') {
                                                ...
                                                if (isset($columnReference[0]) && $columnReference[0] == '[') {
