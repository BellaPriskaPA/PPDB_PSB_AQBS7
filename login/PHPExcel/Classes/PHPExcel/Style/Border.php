...
class PHPExcel_Style_Border extends PHPExcel_Style_Supervisor implements PHPExcel_IComparable
{
    ...
    /**
     * Parent borders object (only used for supervisors)
     *
    ...
    public function getSharedComponent()
    {
        switch ($this->parentPropertyName) {
            ...
            default:
                throw new PHPExcel_Exception('Unknown parent property name: ' . $this->parentPropertyName);
        }
    }
    ...
    {
        // Default key derived from parent property name
        ...
        switch ($this->parentPropertyName) {
            ...
            case 'top':
            case 'vertical':
                // In the original library some cases map to a specific key; keep default behavior
                $key = strtolower($this->parentPropertyName);
                break;
            default:
                // keep provided property name as key
                $key = strtolower($this->parentPropertyName);
                break;
        }
