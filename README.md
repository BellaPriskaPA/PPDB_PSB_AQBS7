...
Dokumentasi Web PSB SD N Kerdonmiri 2
=======================================
...
URL Login
---------
URL login admin: http://localhost/psb/login/
...
Fitur Aplikasi
--------------
Berikut adalah fitur-fitur yang tersedia dalam aplikasi PSB SD N Kerdonmiri 2:

1. Landing Page: Halaman utama aplikasi yang menyajikan informasi singkat tentang PSB SD N Kerdonmiri.

2. Home: Halaman beranda setelah login. Menampilkan informasi penting terkait PSB dan navigasi menu ke fitur-fitur lainnya.
...
7. Data PSB: Fitur untuk mengelola data calon peserta didik baru, termasuk pengelolaan data pendaftaran, verifikasi berkas, dan pengumuman hasil seleksi.
...
15. Cetak: Fitur untuk mencetak laporan dan dokumen terkait PSB, seperti kartu peserta, kartu hasil seleksi, dan lain-lain.
