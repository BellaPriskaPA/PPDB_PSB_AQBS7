...
<body>
  ...
  <script>
		...
		// Submit form pendaftaran (form-daftar dan form-daftar2)
		$('#form-daftar, #form-daftar2').submit(function(e) {
			e.preventDefault();
			$.ajax({
				type: 'POST',
				url: 'crud_web.php?pg=daftar', // Pastikan endpoint ini benar
				data: $(this).serialize(),
				beforeSend: function() {
					$('#btnsimpan').prop('disabled', true);
				},
		...
		// Inisialisasi datepicker dan select2
