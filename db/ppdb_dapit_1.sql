...
--
-- Host: localhost:3306
-- Generation Time: Nov 03, 2025 at 03:53 AM
...
-- ==========================================================
-- PERINTAH TAMBAHAN AGAR TIDAK ERROR
-- ==========================================================
CREATE DATABASE IF NOT EXISTS `ppdb_dapit_1`;
USE `ppdb_dapit_1`;
-- ==========================================================
...
(1, '\'AISYIYAH QUR\'ANIC BOARDING SCHOOL', 3, '-', '20402448', 'Swasta', 'Jl. Letjen Suprato, Gg. 2 Ronowijayan, Siman, Ponorogo.', 'Ponorogo', 'Jawa Timur', 'assets/img/logo/logo_baru.png', NULL, 'ptq.aisyiyah@gmail.com', '-', 'Assalamu Alaikum\r\n\r\nMohon informasi PPDB', 'Assalamu Alaikum\r\n\r\nMohon informasi PPDB', '82226246960', '<p>Pembayaran Pendaftaran bisa di transfer melalui :<br>BRI - 12353435 - SDN Kerdonmiri</p><p>BCA - 123513 - SDN Kerdonmiri</p>', '<p><br></p><ol><li>Surat Keterangan Lulus</li><li>Akta Kelahiran</li><li>Kartu Keluarga</li></ol>', ' Kab.Ponorogo', ' Kec. Siman', '', 'Ustadz Rifqi', '-', '1', 'assets/img/kop/kop163.png', 'assets/img/logo/logo_ppdb1.png', '2025-10-28', '2021-05-20');
