          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="gelombangModalLabel">Setting Gelombang PPDB</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>
              <form id="formGelombang" method="post" action="simpan_gelombang.php">
                <div class="modal-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="bulan_mulai" min="1" max="12" required>
                  </div>
                  <div class="form-group">
                    <label for="gelombang">Gelombang</label>
                    <input type="number" class="form-control" name="gelombang" min="1" required>
                  </div>
                </div>
      ...
      <div class="main-wrapper main-wrapper-1">
        ...
        <nav class="navbar navbar-expand-lg main-navbar">
          ...
          <ul class="navbar-nav navbar-right">
            ...
            <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                <img alt="image" src="../<?= !empty($siswa['foto']) ? $siswa['foto'] : 'assets/img/avatar/avatar-1.png' ?>" class="rounded-circle mr-1">
        ...
        <div class="main-sidebar sidebar-style-2">
          <aside id="sidebar-wrapper">
            <div class="sidebar-brand" style="background-color: #003366;">
              <img src="../<?= $setting['logo_ppdb'] ?>" width="200" alt="PSB">&nbsp;
            </div>
        ...
        <footer class="main-footer">
            ...
            Copyright &copy; <?= date('Y') ?> PSB <div class="bullet"></div> <?= $setting['nama_sekolah'] ?> 
          </div>
