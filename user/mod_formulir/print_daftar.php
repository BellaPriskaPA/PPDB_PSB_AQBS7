...
<html>
	<head>
		<title>Formulir_PSB<?= $siswa['nama'] ?></title>
	</head>
	<body onload="window.print();">
		<img src="assets\img\kop\logo_baru.png
		" width="50%" />
		...
		<br>
			...
			<table width="100%" style="font-size: 10px" cellpadding="1" cellspacing="0" style="border-bottom:1px solid #a5a5a5;">
			<tbody>
			<tr>
		...
		<table width="100%" style="font-size: 25px" cellpadding="1" cellspacing="0" style="border-bottom:1px solid #a5a5a5;">
			<tbody>
			<tr>
