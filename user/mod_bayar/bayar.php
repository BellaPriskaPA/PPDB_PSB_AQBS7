...
<div class="row">
    <div class="col-12">
        <div class="alert alert-info" role="alert">
            ...
            <?php 
            if ($siswa['status'] == 0) {
                echo '<span class="badge badge-secondary">Diverifikasi</span> - Tunggu hasil verifikasi admin';
            } elseif ($siswa['status'] == 1) {
                echo '<span class="badge badge-warning">Buka Pembayaran Awal</span> - Silakan lakukan pembayaran pendaftaran';
            } elseif ($siswa['status'] == 2) {
                echo '<span class="badge badge-success">Diterima</span> - Silakan lakukan pembayaran daftar ulang';
            } elseif ($siswa['status'] == 3) {
                echo '<span class="badge badge-info">Buka Daftar Ulang</span> - Silakan lakukan pembayaran daftar ulang';
            }
            ?>
        </div>
    </div>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                ...
                <?php 
                if ($siswa['status'] == 1) {
                    echo ' - Pembayaran Awal/Pendaftaran';
                } elseif ($siswa['status'] == 2 || $siswa['status'] == 3) {
                    echo ' - Pembayaran Daftar Ulang';
                }
                ?>
                </h4>
    ...
    $('#form-bayar').submit(function(e) {
        ...
        $.ajax({
            ...
            success: function(data) {
                console.log('RESPONS AJAX:', data);
                if (data && data.toLowerCase().indexOf('ok') !== -1) {
                    ...
                    let errorMsg = 'Gagal menyimpan pembayaran';
